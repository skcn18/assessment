(function() {
    ...
    assessmentButton.onclick = () => {
        ...
        // anchor.textContent = 'hoge';
        // anchor.showCount = 'false';
    ...
    const answers = [
        ...
        '{userName}のいいところはいいところは用心深さです。{userName}の洞察に、多くの人が助けられます。',
        '{userName}のいいところは見た目です。内側から溢れ出る{userName}の良さに皆が気を惹かれます。',
        '{userName}のいいところは決断力です。{userName}がする決断にいつも助けられる人がいます。',
        '{userName}のいいところは思いやりです。{userName}が気にかけてもらった多くの人が感謝しています。',
